          ...
          {activeTab === 'password' && (
            <form onSubmit={handlePasswordChange} className="space-y-4 sm:space-y-5">
              ...
              <div className="flex space-x-3 pt-4 sm:pt-6">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 sm:py-3 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white rounded-lg sm:rounded-xl text-sm sm:text-base font-medium transition-all duration-200 hover:scale-[0.98] shadow-lg hover:shadow-xl"
                >
                  Update Password
                </button>
              </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between p-3 sm:p-4 border border-border rounded-lg sm:rounded-xl">
                  ...
                  <button className="px-3 py-1.5 sm:px-4 sm:py-2 bg-primary text-white rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium hover:bg-primary/90 transition-colors">
                    Enable
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-3 sm:p-4 border border-border rounded-lg sm:rounded-xl">
                  ...
                  <button className="px-3 py-1.5 sm:px-4 sm:py-2 bg-secondary text-foreground rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium hover:bg-secondary/80 transition-colors">
                    Setup
                  </button>
                </div>
              </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              {activeSessions.map((session) => (
                <div key={session.id} className="flex items-center justify-between p-3 sm:p-4 border border-border rounded-lg sm:rounded-xl">
                  ...
                  {!session.current && (
                    <button className="px-2 py-1 sm:px-3 sm:py-1.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg text-xs sm:text-sm font-medium transition-colors">
                      Revoke
                    </button>
                  )}
                </div>
