      ...
      <div className="glass w-full sm:max-w-lg rounded-3xl max-h-[85vh] flex flex-col border border-border shadow-premium-lg animate-scale-in">
        <div className="flex-shrink-0 glass-premium border-b border-border px-6 py-5 flex justify-between items-center rounded-t-3xl">
          <div className="flex items-center gap-3">
            ...
            <h2 className="heading-sub text-foreground">Add Loan</h2>
          </div>
          <button 
            onClick={onClose} 
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-5">
          <div>
            <label className="block label-text text-foreground mb-3">Type</label>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => setFormData({ ...formData, direction: 'given' })}
                className={`py-4 rounded-2xl btn-text transition-all duration-200 ${
          ...
          <div>
            <label className="block label-text text-foreground mb-3">Person *</label>
            <input
              type="text"
          ...
          <div>
            <label className="block label-text text-foreground mb-3">Reason</label>
            <input
              type="text"
          ...
          <div className="flex space-x-4 pt-6">
            ...
            <button
              type="submit"
              className="flex-1 py-4 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white rounded-2xl btn-text transition-all duration-200 hover:scale-[0.98] shadow-lg hover:shadow-xl"
            >
              Save Loan
            </button>
          </div>
